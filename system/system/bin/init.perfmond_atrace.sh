...
if [ -f "/data/local/traces/atrace_categories" ]; then
    ...
    category_cmd='gfx input view webview wm am sm audio video camera hal res dalvik rs power pm ss aidl sched irq freq idle binder_lock binder_driver memreclaim thermal'
fi
